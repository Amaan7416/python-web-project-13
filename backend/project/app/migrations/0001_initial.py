# Generated by Django 6.1 on 2026-08-27 12:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Reviewer_Comment', models.CharField(choices=[('Installation pending', 'Installation pending'), ('Document verification in Progress', 'Document verification in Progress'), ('Installation Completed', 'Installation Completed'), ('KYC failed', 'KYC failed')], max_length=50)),
